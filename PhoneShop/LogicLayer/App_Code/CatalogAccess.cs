...
public static class CatalogAccess
{
    ...
    public static DataTable GetDepartments()
    {
        ...
        OracleParameter p2 = new OracleParameter("all_dept", OracleDbType.RefCursor);
    ...
    public static DataTable GetFeedbacks(string productId)
    {
        OracleCommand comm = GenericDataAccess.CreateCommand();
        comm.CommandText = "CatalogGetProductFeedbacks";
        OracleParameter param = comm.Parameters.Add("prod_id", OracleDbType.Int32);
        param.Direction = ParameterDirection.Input;
        param.Value = Int32.Parse(productId);
        OracleParameter param2 = comm.Parameters.Add("all_out", OracleDbType.RefCursor);
    ...
    public static bool AddFeedback(int rating1, int rating2, int rating3, string comments, int productID)
    {
        OracleCommand comm = GenericDataAccess.CreateCommand();
        comm.CommandText = "CatalogAddFeedback";
        comm.CommandType = CommandType.StoredProcedure;

        OracleParameter param = comm.Parameters.Add("productid", OracleDbType.Int32);
        param.Direction = ParameterDirection.Input;
        param.Value = productID;
        param = comm.Parameters.Add("rating1", OracleDbType.Int32);
        param.Direction = ParameterDirection.Input;
        param.Value = rating1;
        param = comm.Parameters.Add("rating2", OracleDbType.Int32);
        param.Direction = ParameterDirection.Input;
        param.Value = rating2;
        param = comm.Parameters.Add("rating3", OracleDbType.Int32);
        param.Direction = ParameterDirection.Input;
        param.Value = rating3;;
        param = comm.Parameters.Add("comments", OracleDbType.Varchar2);
        param.Direction = ParameterDirection.Input;
