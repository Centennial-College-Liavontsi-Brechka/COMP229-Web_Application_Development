...
public class ShoppingCartAccess
{
  ...
  public static bool sendMessage(int orderID, string giftMessage, string giftImage)
  {
      // get a configured OracleCommand object
      OracleCommand comm = GenericDataAccess.CreateCommand();
      // set the stored procedure name
      comm.CommandText = "SENDGIFTMESSAGE";
      // create a new parameter
      OracleParameter param = comm.Parameters.Add("orderID", OracleDbType.Int32);
      param.Direction = ParameterDirection.Input;
      param.Value = orderID;
      // create a new parameter
      OracleParameter param1 = comm.Parameters.Add("giftMessage", OracleDbType.Varchar2);
      param1.Direction = ParameterDirection.Input;
      param1.Value = giftMessage;

      // create a new parameter
      OracleParameter param2 = comm.Parameters.Add("giftImage", OracleDbType.Varchar2);
      param2.Direction = ParameterDirection.Input;
      param2.Value = giftImage;
