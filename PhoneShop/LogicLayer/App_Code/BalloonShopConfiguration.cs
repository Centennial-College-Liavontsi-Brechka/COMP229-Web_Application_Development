...
public static class BalloonShopConfiguration
{
  ...
  static BalloonShopConfiguration()
  {
    ...
    dbConnectionString = ConfigurationManager.ConnectionStrings["PhoneShopConnectionString"].ConnectionString;
    dbProviderName = ConfigurationManager.ConnectionStrings["PhoneShopConnectionString"].ProviderName;
